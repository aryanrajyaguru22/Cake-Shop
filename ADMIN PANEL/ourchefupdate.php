...
$sel=mysqli_query($conn,"select * from ourchef where ch_id=$id");
...
if (isset($_REQUEST['sub']))
{
    ...
    if (! file_exists($_FILES["file-input"]["tmp_name"])) {
		...
		$up=mysqli_query($conn,"update ourchef set ch_name='$ch_name',description='$description',image='$file' where ch_id=$id");

		if($up)
		{
			header("location:ourchefview.php");
		}
		else
		{
...
{  
    var ch_id=document.myform.ch_id.value;
...
<div class="header"> 
          <br><br>
            ...
            <h2><center>Our Chef Update</center></h2>
                                ...
                                <div class="panel-body">
                                    <form method="post" onsubmit="return validateform()" name="myform" enctype="multipart/form-data">
                                    	<div class="form-group">
                                            ...
                                            <input type="hidden" name="ch_id" value="<?php echo $row['ch_id']?>" class="form-control"  >
                                        </div>
                                        <div class="form-group">
                                            <label for="ch_name">Chef Name</label>
                                            <input type="text" name="ch_name" value="<?php echo $row['ch_name']?>" class="form-control" >
                                        </div>
                                        <div class="form-group">
