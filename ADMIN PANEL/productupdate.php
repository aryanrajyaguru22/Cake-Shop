...
if (isset($_REQUEST['sub']))
{
    ...
    if (! file_exists($_FILES["file-input"]["tmp_name"])) {
		...
		$up=mysqli_query($conn,"update product set p_name='$name',price='$price',description='$description',image='$file' where p_id=$id");
...
?>
     <div class="header"> 
          <br><br>
            ...
            <h2><center>Product Update</center></h2>
                                ...
                                <div class="panel-body">
                                    <form method="post" onsubmit="return validateform()" name="myform" enctype="multipart/form-data">
                                    	<div class="form-group">
                                            ...
                                            <input type="text" name="p_id" value="<?php echo $row['p_id']?>" class="form-control"  >
                                        </div>
                                        <div class="form-group">
