...
$sel=mysqli_query($conn,"select * from category where cat_id=$id");
...
if (isset($_REQUEST['sub']))
{
		...
		$up=mysqli_query($conn,"update category set title='$title' where cat_id=$id");
...
?>
    ...
    <div class="header"> 
          <br><br>
            ...
            <h2><center>Category Update</center></h2>
                                ...
                                <div class="panel-body">
                                    <form method="post" onsubmit="return validateform()" name="myform" enctype="multipart/form-data">
                                    	<div class="form-group">
                                            ...
                                            <input type="text" name="cat_id" value="<?php echo $row['cat_id']?>" class="form-control"  >
                                        </div>
                                        <div class="form-group">
