...
$sel=mysqli_query($conn,"select * from subcategory where sub_cat_id=$id");
...
if (isset($_REQUEST['sub']))
{
    ...
    if (! file_exists($_FILES["file-input"]["tmp_name"])) {
		...
		$up=mysqli_query($conn,"update subcategory set content='$content',description='$description',price='$price',image='$file' where sub_cat_id=$id");
...
{  
    var sub_cat_id=document.myform.sub_cat_id.value;
    var content=document.myform.content.value;
    var description=document.myform.description.value;
    var price=document.myform.price.value;
  
    if (name==null || sub_cat_id=="")
    {  
            alert("Please Enter Sub Category ID");  
            return false;  
    }
...
?>
    ...
    <div class="header"> 
          <br><br>
            ...
            <h2><center>Sub-Category Update</center></h2>
                                ...
                                <div class="panel-body">
                                    <form method="post" onsubmit="return validateform()" name="myform" enctype="multipart/form-data">
                                       <div class="form-group">
                                            <label for="sub_cat_id">sub_cat_id</label>
                                            <input type="text" name="sub_cat_id" value="<?php echo $row['sub_cat_id']?>" class="form-control"  >
                                        </div>
                                        <div class="form-group">
                                            <label for="content">Subcategory Content</label>
                                            <input type="text" name="content" value="<?php echo $row['content']?>" class="form-control"  >
                                        </div>
                                           <div class="form-group">
