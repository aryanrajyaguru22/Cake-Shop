...
$sel=mysqli_query($conn,"select * from admin_register where id=$id");
...
<div class="header"> 
          <br><br>
            ...
            <h2 style="text-align:center;">Admin Update</h2>
                                ...
                                <div class="panel-body">
                                    <form method="post" onsubmit="return validateform()" name="myform" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="pass" value="<?php echo $row['pass']?>" class="form-control" >
                                        </div>
                                        <div class="form-group">
