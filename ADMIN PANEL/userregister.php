...
if(isset($_REQUEST['sub']))
{
        ...
        $insert=mysqli_query($conn,"insert into user_register (name,email,pass,address,phone,gender) values ('$name','$email',$pass,'$address','$phone','$gender')");
        if($insert)
        {
                ...
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="register-form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="file"><i class="zmdi zmdi-file"></i></label>
                            ...
                            <div class="form-group">
                               <textarea id="address" name="address" rows="4" cols="40" placeholder="Address"/></textarea>
                            </div>
