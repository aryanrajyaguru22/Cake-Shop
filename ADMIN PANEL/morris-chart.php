...
<!-- Mirrored from webthemez.com/demo/brilliant-free-bootstrap-admin-template/morris-chart.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Feb 2021 12:06:52 GMT -->
<head>
      <meta charset="utf-8" />
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index-2.php"><strong><i class="icon fa fa-plane"></i> CAKE SHOP</strong></a>
				<div id="sideNav" href="#">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="index-2.php"><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
					 ...
					 <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="chart.php">Charts JS</a>
                            </li>
                            <li>
                                <a href="morris-chart.php">Morris Chart</a>
                            </li>
							</ul>
						</li>	
                    <li>
