...
$sel=mysqli_query($conn,"select * from slider where sid=$sid");
...
if (isset($_REQUEST['sub']))
{
    ...
    if (! file_exists($_FILES["file-input"]["tmp_name"])) {
		...
		$up=mysqli_query($conn,"update slider set title='$title',content='$content',image='$file' where sid=$sid");
...
{ 
    ...
    var name=document.myform.title.value;
    var content=document.myform.content.value;
  
    if (name==null || sid=="")
    {  
            alert("Please Enter Slider ID");  
            return false;  
    }
...
?>
     <div class="header"> 
          <br><br>
            ...
            <h2><center>Slider Update</center> </h2>
                                ...
                                <div class="panel-body">
                                    <form method="post" onsubmit="return validateform()" name="myform" enctype="multipart/form-data">
                                    	<div class="form-group">
                                            ...
                                            <input type="hidden" name="sid" value="<?php echo $row['sid']?>" class="form-control"  >
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="file-input" name="file-input" value="<?php echo $row['image']?>" id="exampleInputFile"> 
                                        </div>
