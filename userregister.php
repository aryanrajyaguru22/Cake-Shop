...
if(isset($_REQUEST['sub']))
{
    ...
    if (! file_exists($_FILES["file-input"]["tmp_name"])) {
        ...
        $sql=mysqli_query($conn,"select * from user_register where name='$name'");
        ...
        $insert=mysqli_query($conn,"insert into user_register (name,email,pass,phone,address,image) values ('$name','$email','$pass',$phone,'$address','$file')");
...
<?php } ?>
                        ...
                        <form method="POST" class="register-form" onsubmit="return validateform()" name="myform" id="register-form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                               <textarea id="address" name="address" rows="4" cols="35" placeholder="Address"/></textarea>
                            </div>
                             <div class="form-group">
