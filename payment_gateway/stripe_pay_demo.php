...
if(isset($_POST['stripeToken']))
{
	...
	$query= "insert into payment(`porder_id`,`pamount`,`card_number`,`expireDate`,`cvv_no`,`status`,`invoice`)values('$order_id','$amount_cents','$cardNu','$expireDate','$cvc','success','$invoice')";
...
<h1 class="bt_title" style="color:white">Cake Shop Payment</h1>
...
<div class="dropin-page">
  ...
  <div class="form-row">
    <label>
      <br><span ><b style="color:white">CVC</b></span><br>
