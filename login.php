...
if (isset($_REQUEST['sub']))
{
  ...
  $log=mysqli_query($conn,"select * from user_register where name='$name'and pass='$pass'");
  ...
  {
    $_SESSION['user']=$row;
    if(!empty($_SESSION['tmp_name'])){
        $url = $_SESSION['tmp_name']."?sub_cat_id=".$_SESSION['product_id'];
        header("location:$url");
    }else{
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="userregister.php" class="signup-image-link">Create an account</a>
                    </div>
