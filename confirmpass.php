...
if (isset($_REQUEST['sub']))
{
 ...
 $confirm=$_POST['conpass'];
  ...
  if($new == $confirm)
  {
    $sql=mysqli_query($conn,"update user_register set pass='$new' where email='$email'" );
    if($sql)
    {
...
<?php } ?>
                        ...
                        <form method="post" action="confirmpass.php" class="register-form" onsubmit="return validateform()" name="myform" id="login-form" action="login.php">
                            <div class="form-group">
                                ...
                                <input type="Password" name="newpass" id="email" placeholder="Enter New Password"/>
                            </div>
                            
                            <div class="form-group">
                                <label for="your_pass"><i class="zmdi zmdi-comment-text"></i></label>
                                <input type="Password" name="conpass" id="email" placeholder="Enter Confirm Password"/>
                            </div>
